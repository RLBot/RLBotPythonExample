...
# For example, set center to your car's location and ori to your car's orientation, then target will be
# relative to your car! The resulting vector consists of:
# x - how far in front
# y - how far right
# z - how far above
def relative_location(center, target, ori):
    """Returns target as a relative location from center's point of view, using the given orientation."""
